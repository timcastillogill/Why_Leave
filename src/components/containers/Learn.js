    ...
    <div className="Learn">
      <div className="box1">
        ...
        <p>
          ...
          and men flee from violence, war, hunger, extreme poverty, because of
          their sexual or gender orientation, or from the consequences of
          climate change or other natural disasters. Often people will ace a
          combination of these difficult circumstances. People who leave their
          countries are not always fleeing danger. They might believe they have
          a better chance of finding work in another country because they have
          the education or capital to seek opportunities elsewhere. Others might
          want to join relatives or friends who are already living abroad. Or
          they might seek to start or finish their education in another country.
          There are lots of different reasons for people to start a journey to
      ...
      <div className="left">
        <div className="box2">
          ...
          <p>
            ...
            country because their own government cannot or will not protect them
            from those dangers. Refugees have a right to international
            protection.
          </p>
        </div>
      </div>
      <div className="right">
        <div className="box4">
          ...
          <p>
            ...
            or join family, for example. Others feel they must leave because of
            poverty, political unrest, gang violence, natural disasters or other
            erious circumstances that exist there.
          </p>
          <p>
